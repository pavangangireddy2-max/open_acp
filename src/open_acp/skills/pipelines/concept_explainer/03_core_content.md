...
- Objectives artifact (objectives, coverage_matrix)
...
- Know which objectives each section serves (from coverage_matrix)
...
- Every section serves at least one objective from the coverage matrix
