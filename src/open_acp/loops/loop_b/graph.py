...
class LoopBGraphState(TypedDict, total=False):
    ...
    brief_artifact_path: Annotated[Any, _replace]
    ...
    curriculum_artifact_path: Annotated[Any, _replace]
    curriculum_validation_report: Annotated[Any, _replace]
    design_artifact_paths: Annotated[Any, _replace]
    ...
    course_design_artifact_path: Annotated[Any, _replace]
    module_design: Annotated[Any, _replace]
    module_design_artifact_path: Annotated[Any, _replace]
    topic_design: Annotated[Any, _replace]
    topic_design_artifact_path: Annotated[Any, _replace]
