...
class MCQGenerator(BaseTool):
    ...
    cost_per_call = 0.02
    description = "Generate multiple choice questions with distractors and explanations"
    agent_skills = ["claude_api_patterns"]

    def execute(self, **kwargs) -> ToolResult:
        prompt = kwargs.get("prompt", "")
        system = kwargs.get("system", "You are an expert assessment designer creating MCQs.")
